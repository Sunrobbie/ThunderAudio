...
void I2CSPM_Init(I2CSPM_Init_TypeDef *init)
{
  ...
  GPIO_PinModeSet(init->sclPort, init->sclPin, _GPIO_P_MODEL_MODE0_WIREDANDPULLUP, 1);
  GPIO_PinModeSet(init->sdaPort, init->sdaPin, _GPIO_P_MODEL_MODE0_WIREDANDPULLUP, 1);
